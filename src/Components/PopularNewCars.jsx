...
function PopularNewCars() {
  const [cars, setCars] = React.useState(<PopularCars/>)
    ...
    function func(){
        ...
        if(btn4){
          btn4.style.borderBottom = "4px solid red"
      ...
      function func2(){
        ...
        if(btn5){
          ...
          btn5.style.borderBottom = "4px solid red"
          btn6.style.borderBottom = "none"
      ...
      function func3(){
        ...
        if(btn6){
          btn4.style.borderBottom = "none"
          btn5.style.borderBottom = "none"
          btn6.style.borderBottom = "4px solid red"
        }
    ...
    <div className="flex  sans w-full    items-center  border-b-[2px] border-gray-100 justify-around h-[5rem]  ">
      <button id="btn4" onClick={func}  className="bg-white w-[10rem] max-sm:text-[0.75rem] border-b-[4px] max-sm:w-[8rem] border-red-500 rounded-sm   capitalize font-semibold max-sm:h-fit h-full p-1">popular cars</button>
